...
<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button v-hasPermi="['PRIV_JOBLOG_DELETE']" type="danger" plain icon="delete" :disabled="multiple" @click="handleDelete">
          删除
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button v-hasPermi="['PRIV_JOBLOG_REMOVE']" type="danger" plain icon="delete" :disabled="total <= 0" @click="handleClean">
          清空
        </el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button v-hasPermi="['PRIV_JOBLOG_EXPORT']" type="warning" plain icon="download" @click="handleExport">
          导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="jobLogList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button text icon="view" @click="handleView(scope.row)">
            详细
          </el-button>
        </template>
      </el-table-column>
    ...
    <!-- 调度日志详细 -->
    <el-dialog v-model="open" title="日志详细" width="700px" append-to-body>
