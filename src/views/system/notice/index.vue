...
import { addNotice, delNotice, getNotice, listNotice, sendNotice, updateNotice } from '@/api/system/notice'
  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button v-hasPermi="['system:notice:edit']" size="small" text icon="bell" @click="handleNotice(scope.row)">
            通知
          </el-button>
          <el-button v-hasPermi="['system:notice:edit']" size="small" text icon="Edit" @click="handleUpdate(scope.row)">
            修改
          </el-button>
          <el-button v-hasPermi="['system:notice:remove']" size="small" text icon="Delete" @click="handleDelete(scope.row)">
            删除
          </el-button>
        </template>
      </el-table-column>
