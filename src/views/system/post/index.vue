  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="postList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button v-hasPermi="['system:post:edit']" text size="small" icon="edit" @click="handleUpdate(scope.row)">
            {{ $t('btn.edit') }}
          </el-button>
          <el-button v-hasPermi="['system:post:remove']" text size="small" icon="delete" @click="handleDelete(scope.row)">
            {{ $t('btn.delete') }}
          </el-button>
        </template>
      </el-table-column>
