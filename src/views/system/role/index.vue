...
<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button v-hasPermi="['system:role:add']" type="primary" plain icon="plus" size="small" @click="handleAdd">
          {{ $t('btn.add') }}
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="roleList" highlight-current-row @selection-change="handleSelectionChange">
      ...
      <el-table-column label="权限范围" prop="dataScope" :formatter="dataScopeFormat" />
    ...
    <!-- 角色菜单弹框 -->
    <el-dialog v-model="showRoleScope" title="角色权限分配" width="500px">
      <el-form :model="form" label-width="80px">
        <el-form-item label="菜单搜索">
          <el-input v-model="searchText" placeholder="请输入关键字进行过滤" />
        </el-form-item>
      ...
      <template #footer>
        ...
        <el-button v-hasPermi="['system:role:authorize']" type="primary" @click="submitDataScope">
          {{ $t('btn.save') }}
        </el-button>
      </template>
    </el-dialog>
