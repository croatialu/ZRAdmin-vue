  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="typeList" border @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button v-hasPermi="['system:dict:edit']" text size="small" icon="edit" @click="handleUpdate(scope.row)">
            {{ $t('btn.edit') }}
          </el-button>
          <el-button v-hasPermi="['system:dict:remove']" text size="small" icon="delete" @click="handleDelete(scope.row)">
            {{ $t('btn.delete') }}
          </el-button>
        </template>
      </el-table-column>
    ...
    <el-dialog v-model="dictDataVisible" width="60%" :lock-scroll="false">
      <dict-data v-model:dictId="dictId" />
    </el-dialog>
  </div>
</template>
