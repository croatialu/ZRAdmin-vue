...
import { cleanOperlog, delOperlog, exportOperlog, list as listOperLog } from '@/api/monitor/operlog'
...
<template>
  <div class="app-container">
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button v-hasPermi="['system:operlog:export']" type="warning" plain icon="download" @click="handleExport">
          导出
        </el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="list" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template #default="scope">
          <el-button v-hasPermi="['monitor:operlog:query']" size="small" text icon="view" @click="handleView(scope.row, scope.index)">
            详细
          </el-button>
        </template>
      </el-table-column>
