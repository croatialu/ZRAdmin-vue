  ...
  <div class="icon-body">
    ...
    <el-tabs v-model="activeName">
      <el-tab-pane label="svg-icon" name="1">
        <div class="icon-list">
          <div v-for="(item, index) in iconList" :key="index" class="icon-item mb10" @click="selectedIcon(item, '')">
      ...
      <el-tab-pane label="Element-UI Icons" name="2">
        <div class="icon-list">
          <div v-for="item of elementIcons" :key="item" class="icon-item mb10" @click="selectedIcon(item, 'ele-')">
