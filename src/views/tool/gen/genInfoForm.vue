    ...
    <el-row>
      <el-col :lg="12">
        <el-form-item prop="tplCategory">
          ...
          <el-select v-model="info.tplCategory" @change="tplSelectChange">
            ...
            <el-option label="导航查询(1对1)" value="subNav" />
            <el-option label="导航查询(1对多)" value="subNavMore" />
      ...
      <el-col :lg="12">
        <el-form-item label="默认查询排序字段">
          ...
          <el-radio v-model="info.sortType" label="asc">
            正序
          </el-radio>
          <el-radio v-model="info.sortType" label="desc">
            倒序
          </el-radio>
        </el-form-item>
      </el-col>
      <el-col :lg="12">
        <el-form-item prop="permissionPrefix">
          ...
          <el-input v-model="info.permissionPrefix" placeholder="请输入权限前缀" />
        </el-form-item>
      </el-col>
      <el-col :lg="12">
      ...
      <el-col v-if="info.genType == '1'" :lg="24">
      ...
      <el-col :lg="12">
        <el-form-item prop="colNum" label="一行显示列">
          <el-radio v-model="info.colNum" :label="12">
            2列
          </el-radio>
          <el-radio v-model="info.colNum" :label="24">
            1列
          </el-radio>
        </el-form-item>
      </el-col>
      <el-col v-show="info.tplCategory != 'select'" :lg="24">
